...
describe.only("DemKidos Test", async () => {
  ...
  async function deployERC404Example() {
    ...
    const initialOwnerAddr = await initialOwner.getAddress();
    const initialMintRecipientAddr = await initialMintRecipient.getAddress();
    const idPrefix =
      57896044618658097711785492504343953926634992332820282019728792003956564819968n;

    const [demKidosArgs] = await deployFacets("DemKidos");

    const contractAddress = await deployDiamond(
      initialOwnerAddr,
      "Kidos",
    ...
    await (await contract.initMintSupply(maxTotalSupplyERC721)).wait();
  ...
  async function deployMinimalERC404() {
    ...
    const [demKidosArgs] = await deployFacets("MinimalERC404");
